  ...
  return (
    <div className="narrow stack-lg">
      ...
      <Card>
        ...
        <ul className="stack">
          <li>
            <Link href="/account/security">Security and sessions</Link>
          </li>
          {meta.features.billing ? (
            <li>
              <Link href="/account/billing">Billing and reservations</Link>
            </li>
          ) : null}
          {me.user.isPlatformAdmin ? (
            <li>
              <Link href="/admin">Support tools</Link>
            </li>
          ) : null}
          <li>
